# SailfishOS-Apps-no_NB
Norwegian Bokmål translations of applications available on SailfishOS

# Oversettelser av programvare for mobiltelefonplattformen SailfishOS

Programvare gjør seg på norsk! Mitt hobby-prosjekt er SailfishOS-plattformen og jeg har oversetter en del programmer jeg bruker til norsk bokmål.
...
- [Muuzik!](https://github.com/fsilye/SailfishOS-Apps-no_NB/blob/main/vi18n-no_NB.properties): En musikkavspiller
  - [Last ned fra OpenRepos](https://openrepos.net/content/kan/muuzik)
...
- [Tarkka Magnifier](https://github.com/fsilye/SailfishOS-Apps-no_NB/blob/main/harbour-tarkka-no_NB.ts): Forstørrelsesglassverktøy
  - [Last ned fra OpenRepos](https://openrepos.net/content/fravaccaro/tarkka-magnifier)
...
- [Tooter β](https://github.com/fsilye/SailfishOS-Apps-no_NB/blob/main/harbour-tooterb-nb.ts): En klient for det sosiale nettverket Mastodon
  - [Last ned fra OpenRepos](https://openrepos.net/content/molan/tooter-v)
